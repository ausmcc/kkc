...
{
    resize(900, 520);
    setWindowTitle(tr("Koalakash") + " - " + tr("Wallet"));
...
#endif
    setObjectName("koalakash");
    setStyleSheet("#koalakash { background-color: #ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    progressBar->setStyleSheet("QProgressBar { background-color: #ffffff; border: 0px solid grey; border-radius: 0px; padding: 3px; text-align: center; } QProgressBar::chunk { background: #665959; border-radius: 0px; margin: 0px; }");
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #ffffff; background-color: #ffffff; border: 0px solid grey; border-radius: 0px; padding: 0px; text-align: center; } QProgressBar::chunk { background: #665959; border-radius: 0px; margin: 0px; }");
        }
    }
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #161931, stop: 1 #ddc363);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Koalakash address"));
    ...
    mktAction = new QAction(QIcon(":/icons/marketplace"), "Marketplace", this);
    ...
    pioAction = new QAction(tr("&Koalakash Website"), this);
	pioAction->setToolTip(tr("Visit the Official Koalakash website"));
    bitcointalkAction = new QAction(tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Koalakash discussion thread"));
    chainAction = new QAction(tr("&Koalakash Discord"), this);
    chainAction->setToolTip(tr("Join Koalakash Discord"));
    explorerAction = new QAction(tr("&Koalakash Explorer"), this);
	explorerAction->setToolTip(tr("Koalakash Explorer"));	
    aboutAction = new QAction(tr("&About Koalakash"), this);
    aboutAction->setToolTip(tr("Show information about Koalakash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Koalakash"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 600; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; margin: 5px; border-radius: 4px; }"
                           "QToolButton:hover { background-color: #665959; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:checked { background-color: #665959; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:pressed { background-color: #665959; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "#tabs { color: #000000; background-color: qradialgradient(cx: -0.2, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #161931, stop: 1 #ddc363); border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Koalakash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Koalakash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Koalakash network", "", count));
}
...
void BitcoinGUI::gotomktPage()
{
    ...
    QDesktopServices::openUrl(QUrl("https://kkc.space/marketplace"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Koalakash address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("https://koalakash.space"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://koalakash.space/redirect/bitcointalk"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://koalakash.space/redirect/discord"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://koalakash.space/redirect/explorer"));
}
