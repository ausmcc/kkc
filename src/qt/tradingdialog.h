...
private slots:
    ...
    QString BuyKKC(QString OrderType, double Quantity, double Rate);
    QString SellKKC(QString OrderType, double Quantity, double Rate);
